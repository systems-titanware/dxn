...
pub mod sqlite {
    ...
    */
    pub fn insert(db_name: String, table_name: String, name: String, country: String) -> Result<usize, rusqlite::Error> {
        let conn = Connection::open(format!("{}.db", db_name))?;
    ...
    pub fn update(db_name: String, table_name: String, id: u32, name: String, country: String) -> Result<usize, rusqlite::Error> {
        let conn = Connection::open(format!("{}.db", db_name))?;
